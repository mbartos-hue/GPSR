{* Panel przypisywania produktów do Załącznika *}
<div class="panel">
  <h3>Przypisywanie produktów — Załącznik: #{$attachment->id} {$attachment->name|escape:'htmlall':'UTF-8'}</h3>

  <form method="post" action="{$action_url|escape}" enctype="multipart/form-data">
    <input type="hidden" name="token" value="{$token|escape}">
    <input type="hidden" name="id_gpsr_attachment" value="{$attachment->id|intval}">
